...
export interface EntityEditorProps {
    ...
    noReturn?:boolean;
    loadAction?: string;
    onBuildSubmitPanel?: (props: Editors.IBaseEditorProps, state: Editors.IFormState, children?: JSX.Element) => JSX.Element;
        ...
        return <div className={`entity-editor ${this.props.className || ''}`}>
            ...
            {!this.state.value ? null : <ApiForm
                ...
                onBuildSubmitPanel={(props: Editors.IBaseEditorProps, state: Editors.IFormState) => {
                    ...
                    return this.props.onBuildSubmitPanel ? this.props.onBuildSubmitPanel(props, cmds) : cmds;
                } }
                />
            }
        </div>
