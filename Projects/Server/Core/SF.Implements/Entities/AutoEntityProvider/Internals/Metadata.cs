...
namespace SF.Entities.AutoEntityProvider.Internals
{
	...
	public class EntityType : BaseEntityType, IEntityType
	{
		...
		public EntityType(string Name, string Namespace, bool AutoGenerateDataModel,IReadOnlyList<EntityProperty> Properties, EntityAttribute[] Attributes) : base(Name, Attributes)
		{
