...
namespace SF.Core.Interception
{
	...
	public class GenericParameterMapper
	{
		...
		{
			Ensure.NotNull(reflectedParameters, "reflectedParameters");
			Ensure.NotNull(generatedParameters, "generatedParameters");

			if (reflectedParameters.Length != generatedParameters.Length)
			{
				throw new ArgumentException("reflectedParameters");
			}
