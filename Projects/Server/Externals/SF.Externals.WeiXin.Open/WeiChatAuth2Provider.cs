...
namespace ServiceProtocol.Auth.Externals.Providers.WeiChat
{
    ...
    [TypeDisplay(Name ="微信认证")]
    [ServiceProvider(typeof(IExternalAuthorizationProvider),typeof(WeiChatAuth2Setting))]
	public class WeiChatAuth2Provider : IOAuthAuthorizationProvider
	{
		public WeiChatAuth2Setting Setting { get; }
        public ILogger Logger { get; }

        public WeiChatAuth2Provider(WeiChatAuth2Setting Setting, ILogService LogService)
        {
		...
		public Task<HttpResponseMessage> StartAuthorization(string State,string ClientType,string Callback)
		{
			var uri = new Uri(Setting.AuthorizeUri).WithQueryString(
				...
				new KeyValuePair<string, string>("scope", "snsapi_userinfo"),
