...
namespace WxPayAPI
{
    ...
    {
		public WxPayConfig WxPayConfig { get; set; }
		/**
        * 提交被扫支付API
        ...
        */
		public  WxPayData Micropay(WxPayData inputObj, int timeOut = 10)
        {
           ...
           // inputObj.SetValue("spbill_create_ip", WxPayConfig.IP);//终端ip
            ...
            string response = HttpService.Post(xml, url, false, timeOut,WxPayConfig);//调用HTTP通信接口以提交数据到API
            ...
            result.FromXml(response,WxPayConfig);
        ...
        */
        public WxPayData OrderQuery(WxPayData inputObj, int timeOut = 6)
        {
            ...
            string response = HttpService.Post(xml, url, false, timeOut, WxPayConfig);//调用HTTP通信接口提交数据
        ...
        */
        public WxPayData Reverse(WxPayData inputObj, int timeOut = 6)
        {
            ...
            string response = HttpService.Post(xml, url, true, timeOut, WxPayConfig);
        ...
        */
        public WxPayData Refund(WxPayData inputObj, int timeOut = 6)
        {
            ...
            string response = HttpService.Post(xml, url, true, timeOut, WxPayConfig);//调用HTTP通信接口提交数据到API
	    ...
	    */
	    public WxPayData ShortUrl(WxPayData inputObj, int timeOut = 6)
	    {
            ...
            string response = HttpService.Post(xml, url, false, timeOut, WxPayConfig);
