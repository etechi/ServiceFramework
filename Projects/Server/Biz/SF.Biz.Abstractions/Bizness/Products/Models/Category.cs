...
namespace SF.Biz.Products
{
	...
	{
		[Key]
		[Comment(Name = "ID", Description  = "保存后自动产生")]
		[ReadOnly(true)]
		[TableVisible]
        [Layout(1)]
		...
		[TableVisible]
		[Required]
		[Comment(Name = "名称", Description="内部管理使用，比如：2016夏季促销商品")]
		[StringLength(100)]
        [Layout(2)]
        public string Name { get; set; }

		[Required]
		[Comment(Name = "标题", Description = "用于前端显示，比如：火热夏季专辑")]
		[TableVisible]
		[StringLength(100)]
        [Layout(3)]
        ...
        [Comment(Name = "销售人员", Description = "一般默认即可")]
        //[EntityIdent("产品供应商")]
        [Required]
        [Layout(4)]
