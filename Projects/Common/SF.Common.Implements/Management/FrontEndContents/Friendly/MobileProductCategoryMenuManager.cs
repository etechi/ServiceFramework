...
namespace SF.Management.FrontEndContents
{
	...
	{
		public MobileProductCategoryMenuManager(IFriendlyContentSettingService SettingService, IContentManager<Content> ContentManager) : base(SettingService, ContentManager)
		{
		}
	}
