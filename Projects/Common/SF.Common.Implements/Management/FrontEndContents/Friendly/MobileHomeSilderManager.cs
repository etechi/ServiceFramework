...
namespace SF.Management.FrontEndContents
{
	...
	{
		public MobileHomeSilderManager(IFriendlyContentSettingService SettingService, IContentManager<Content> ContentManager) : base(SettingService, ContentManager)
		{
		}
	}
